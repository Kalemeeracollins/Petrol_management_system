        ...
        const fetchData = async ()=>{
            ...
            try {
                ...
                if (shiftResponse.ok) {
                    ...
                    const activeShift = shifts.find((shift)=>shift.status === "IN_PROGRESS");
                    if (activeShift) {
                        setStats((prev)=>({
                                ...prev,
                                shiftStatus: "ON_DUTY",
                ...
                if (salesResponse.ok) {
                    ...
                    const todaySales = sales.filter((sale)=>sale.saleDate.startsWith(today));
                    const totalSales = todaySales.reduce((sum, sale)=>sum + sale.totalAmount, 0);
                    const totalLiters = todaySales.reduce((sum, sale)=>sum + sale.quantitySold, 0);
                    setStats((prev)=>({
                            ...prev,
...
//# sourceMappingURL=frontend_src_0f280910._.js.map