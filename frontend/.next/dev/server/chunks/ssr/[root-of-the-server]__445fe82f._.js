...
const AuthProvider = ({ children })=>{
    ...
    // Fetch user from backend on initial load
    ...
    const login = async (token)=>{
        // token is set in HttpOnly cookie from backend login route
        // just fetch user to update context
        try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__445fe82f._.js.map