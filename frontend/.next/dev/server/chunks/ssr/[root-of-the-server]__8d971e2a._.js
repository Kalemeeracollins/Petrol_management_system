...
function AuthProvider({ children }) {
    ...
    const register = async (name, email, password)=>{
        ...
        setError(null);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://localhost:5000/api/auth/register", {
                name,
                email,
                password
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8d971e2a._.js.map