...
function AuthProvider({ children }) {
    ...
    const fetchUser = async ()=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("http://localhost:5000/api/auth/me", {
    ...
    const login = async (email, password)=>{
        ...
        setError(null);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://localhost:5000/api/auth/login", {
                email,
                password
            }, {
                withCredentials: true
    ...
    const register = async (name, email, password)=>{
        ...
        setError(null);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://localhost:5000/api/auth/register", {
                name,
                email,
                password
            }, {
    ...
    const logout = async ()=>{
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://localhost:5000/api/auth/logout", {}, {
                withCredentials: true
            } // tells browser to send cookie
            );
        } catch  {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a90c5e1c._.js.map