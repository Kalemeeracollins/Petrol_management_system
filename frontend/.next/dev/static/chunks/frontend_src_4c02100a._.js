...
function Navbar({ theme, toggleTheme }) {
    _s();
    const { user, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
"[project]/frontend/src/components/layout/protected-layout.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProtectedLayout({ children }) {
    _s();
    const { isAuthenticated, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    // -----------------------------
    // 🌙 Dark Mode State
    // -----------------------------
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$layout$2f$navbar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Navbar"], {
...
"[project]/frontend/src/app/admin/pump-attendant/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// pages/pump-attendant.tsx (or your component file)
__turbopack_context__.s([
    "default",
    ()=>PumpAttendantPage
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$layout$2f$protected$2d$layout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/components/layout/protected-layout.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function PumpAttendantPage() {
    ...
    const [attendantMessage, setAttendantMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("") // <-- message for attendant
    ;
    const [showAssignForm, setShowAssignForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [selectedAttendant, setSelectedAttendant] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const fetchAttendants = async ()=>{
        ...
        setError("");
        try {
            const response = await fetch("http://localhost:5000/api/\attendants-with-pumps", {
                credentials: "include"
            });
    ...
    const handleAssignPump = async (e)=>{
        ...
        setError("");
        setSuccess("");
        setAttendantMessage(""); // reset previous message
        if (!selectedAttendant) {
            setError("Please select an attendant");
            return;
        }
        try {
            const response = await fetch("http://localhost:5000/api/pump-assignments/assign", {
                method: "POST",
                headers: {
            ...
            const data = await response.json();
            if (response.ok) {
                setSuccess(data.message || "Pump assigned successfully!");
                if (data.attendantMessage) setAttendantMessage(data.attendantMessage);
                resetForm();
                fetchAttendants();
            } else {
                setError(data.message || "Failed to assign pump");
            }
        } catch (err) {
    ...
    const openAssignForm = (attendantId)=>{
        setSelectedAttendant(attendantId);
        setShowAssignForm(true);
    };
    const assignedAttendants = attendants.filter((a)=>a.PumpAssignments && a.PumpAssignments.length > 0);
    const unassignedAttendants = attendants.filter((a)=>!a.PumpAssignments || a.PumpAssignments.length === 0);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$layout$2f$protected$2d$layout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProtectedLayout"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    attendantMessage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                        variant: "default",
                        className: "mb-6",
                        children: attendantMessage
                    }, void 0, false, {
                        fileName: "[project]/frontend/src/app/admin/pump-attendant/page.tsx",
                        lineNumber: 146,
                        columnNumber: 32
...
_s(PumpAttendantPage, "L5DhX27XwabfcLpHxVagGADm+ZY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=frontend_src_4c02100a._.js.map