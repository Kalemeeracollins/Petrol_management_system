...
"[project]/Desktop/petrol_station/frontend/src/app/attendant/dashboard/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AttendantDashboard() {
    _s();
    const { isAuthenticated, user, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AttendantDashboard.useEffect": ()=>{
            const fetchData = {
                "AttendantDashboard.useEffect.fetchData": async ()=>{
                    if (!isAuthenticated) {
                    ...
                    try {
                        ...
                        if (shiftResponse.ok) {
                            ...
                            const activeShift = shifts.find({
                                "AttendantDashboard.useEffect.fetchData.activeShift": (shift)=>shift.status === "IN_PROGRESS"
                            }["AttendantDashboard.useEffect.fetchData.activeShift"]);
                            if (activeShift) {
                                setStats({
                                    "AttendantDashboard.useEffect.fetchData": (prev)=>({
                                            ...prev,
                                            shiftStatus: "ON_DUTY",
                                            shiftStartTime: activeShift.actualStartTime,
                                            activePump: activeShift.assignedPump || "Pump 1"
                                        })
                                }["AttendantDashboard.useEffect.fetchData"]);
                            }
                        }
                        ...
                        if (salesResponse.ok) {
                            ...
                            const todaySales = sales.filter({
                                "AttendantDashboard.useEffect.fetchData.todaySales": (sale)=>sale.saleDate.startsWith(today)
                            }["AttendantDashboard.useEffect.fetchData.todaySales"]);
                            const totalSales = todaySales.reduce({
                                "AttendantDashboard.useEffect.fetchData.totalSales": (sum, sale)=>sum + sale.totalAmount
                            }["AttendantDashboard.useEffect.fetchData.totalSales"], 0);
                            const totalLiters = todaySales.reduce({
                                "AttendantDashboard.useEffect.fetchData.totalLiters": (sum, sale)=>sum + sale.quantitySold
                            }["AttendantDashboard.useEffect.fetchData.totalLiters"], 0);
                            setStats({
                                "AttendantDashboard.useEffect.fetchData": (prev)=>({
                                        ...prev,
    ...
    const quickActions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AttendantDashboard.useMemo[quickActions]": ()=>[
                {
                    label: "Record Sale",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$src$2f$app$2f$utils$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("min-h-screen", isDarkMode ? "dark bg-slate-950 text-slate-100" : "bg-slate-100 text-slate-900"),
                ...
                children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].h1, {
                                        ...
                                        fileName: "[project]/Desktop/petrol_station/frontend/src/app/attendant/dashboard/page.tsx",
                                        lineNumber: 116,
                                        columnNumber: 15
                                    }, this),
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            stats.shiftStatus === "ON_DUTY" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                                                variant: "success",
                                                children: [
                                                    "✅ You are currently ON DUTY - Shift started at ",
                                                    stats.shiftStartTime ? new Date(stats.shiftStartTime).toLocaleTimeString() : "N/A"
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/Desktop/petrol_station/frontend/src/app/attendant/dashboard/page.tsx",
                                                lineNumber: 217,
                                                ...
                                                variant: "warning",
                                                children: "⚠️ You are currently OFF DUTY - Please start your shift to record sales"
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/petrol_station/frontend/src/app/attendant/dashboard/page.tsx",
                                                lineNumber: 221,
                                                columnNumber: 19
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$src$2f$app$2f$utils$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("lg:col-span-2", isDarkMode ? "bg-slate-900/50 text-slate-100 ring-1 ring-white/10" : "bg-white/95 text-slate-900 ring-1 ring-slate-900/10"),
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$petrol_station$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
...
_s(AttendantDashboard, "Msq4NCtBxOEZKwhP1QqxNepue84=", false, function() {
    return [
...
_c = AttendantDashboard;
var _c;
__turbopack_context__.k.register(_c, "AttendantDashboard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Desktop_petrol_station_frontend_src_4cd61d64._.js.map