        ...
        "AttendantDashboard.useEffect": ()=>{
            const fetchData = {
                "AttendantDashboard.useEffect.fetchData": async ()=>{
                    ...
                    try {
                        await new Promise({
                            "AttendantDashboard.useEffect.fetchData": (res)=>setTimeout(res, 800)
                        }["AttendantDashboard.useEffect.fetchData"]); // mock API call
                        setStats({
                            todaySales: 724500,
...
_s(AttendantDashboard, "ehBSXQprs8kFu5RocaoDKK41wqw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=frontend_src_23627604._.js.map