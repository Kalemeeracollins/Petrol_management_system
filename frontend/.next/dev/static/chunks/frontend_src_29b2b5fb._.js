...
function PumpAttendantPage() {
    _s();
    const { token, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    // Fetch attendants only if token exists
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (!response.ok) {
                ...
                setError(errData.message || "Failed to add attendant");
                return;
            }
            // Clear form and reload attendants
            setFormData({
                name: "",
                assignedPump: "",
                shift: "",
...
_s(PumpAttendantPage, "/c0lhtbd9apHsj3L912doQQQUSw=", false, function() {
    return [
...
//# sourceMappingURL=frontend_src_29b2b5fb._.js.map